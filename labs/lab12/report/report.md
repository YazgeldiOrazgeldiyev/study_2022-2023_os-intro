...
![Первый командный файл](image/1.jpg){#fig:001 width=70%}
...
![Команда man через код](image/3.jpg){#fig:003 width=70%}

4. Выдал необходимые права и запустил команду

![Команда man через код](image/4.jpg){#fig:004 width=70%}
...
![Команда man через код](image/5.jpg){#fig:005 width=70%}

6. Выдал необходимые права генератору букв и запустил команду

![Пример работы кода](image/6.jpg){#fig:006 width=70%}
